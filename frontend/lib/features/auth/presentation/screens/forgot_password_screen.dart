...
class _BambooPainter extends CustomPainter {
  ...
  static const _bamboos = [
    ...
    [0.133, 14.0, 0.13, 1.45], [0.283, 13.0, 0.12, -1.53],
    [0.503, 20.0, 0.13, 2.00], [0.598, 17.6, 0.12, 1.82],
    [0.693, 15.5, 0.11, 1.72], [0.890, 5.2, 0.08, -1.98],
  ];
