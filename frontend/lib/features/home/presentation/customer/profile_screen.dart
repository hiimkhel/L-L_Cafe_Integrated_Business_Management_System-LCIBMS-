...
class _ProfileScreenState extends State<ProfileScreen> {
    ...
    return Row(
      children: [
        ...
        Text(
          ...
          style: const TextStyle(
            fontFamily: 'Urbanist', fontWeight: FontWeight.w900,
            fontSize: 14, letterSpacing: 2.0, color: _bgDark,
  ...
  Widget _buildProfileCard({required bool isMobile}) {
    return Container(
      ...
      child: Column(
        children: [
          // Avatar with decorative beige circle
          Stack(
  ...
  Widget _buildCustomerDetailsCard({required bool isMobile}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        boxShadow: [
          BoxShadow(color: _bgDark.withOpacity(0.06), blurRadius: 30, offset: const Offset(0, 8)),
        ],
      ),
      child: Form(
        key: _formKey,
        child: Column(
          ...
          children: [
            if (!isMobile) ...[
              ...
              // Mobile: stacked fields with edit icons on email and phone
        ...
        Row(
          children: [
            for (int i = 0; i < _deliveryAddresses.length; i++) ...[
              ...
              Expanded(child: _buildAddressCard(_deliveryAddresses[i], showIcon: false)),
            ],
          ],
        ),
        const SizedBox(height: 16),
  ...
  Widget _buildDeliveryAddressesMobile() {
    return Column(
      children: [
        for (final addr in _deliveryAddresses) ...[
          _buildAddressCard(addr, showIcon: true),
  ...
  Widget _buildAddressCard(DeliveryAddress addr, {required bool showIcon}) {
    return Container(
        ...
        children: [
          ...
          if (showIcon) ...[
            ...
            Container(
              ...
              child: Icon(Icons.settings_outlined, size: 16, color: _secondary.withOpacity(0.7)),
            ),
          ],
        ],
      ),
  ...
  Widget _buildAddNewAddressButton() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.location_on_outlined, size: 16, color: _secondary.withOpacity(0.7)),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'ALERT LATEST UPDATE AND EVENT ABOUT LNL\'S CAFE',
                  style: TextStyle(
                    fontFamily: 'Urbanist', fontWeight: FontWeight.w700,
...
// ─────────────────────────────────────────────────────────────────────────────
// BAMBOO BACKGROUND (retained from original)
// ─────────────────────────────────────────────────────────────────────────────
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return CustomPaint(
          painter: _BambooPainter(animationValue: _controller.value, isMobile: isMobile),
          size: Size.infinite,
        );
      },
    );
