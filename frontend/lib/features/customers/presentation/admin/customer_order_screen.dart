...
final List<Order> _demoOrders = [
  Order(
    ...
    items: ['1X HABANERO MANGO', '2X NUTELLA FRAPPE', '2X KITKAT WAFFLE',
            '1X OREO WAFFLE', '1X RED VELVET FRAPPE', '1X S\'MORE',
      ...
      return Padding(
        ...
        child: Center(child: Column(children: [
          Icon(Icons.receipt_long_outlined,
              size: isMobile ? 48 : 56, color: _primary.withOpacity(0.3)),
          const SizedBox(height: 12),
